    ...
    public class MappingProfiles : Profile
    {
        public MappingProfiles()
        {
           ...
           .ReverseMap();
            ...
            //.ForMember(dest => dest.NomPuit, opt => opt.MapFrom(src => src.SourceEau is Puit puit ? puit.NomPuit : string.Empty))
            ...
            //.ForMember(dest => dest.NomBassin, opt => opt.MapFrom(src => src.SourceEau is Bassin bassin ? bassin.NomBassin : string.Empty))
